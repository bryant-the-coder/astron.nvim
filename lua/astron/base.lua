local base = {
	...
	Identifier = { fg = C.blue, bg = C.none, style = Config.italic_variables },
	Function = { fg = C.yellow, bg = C.none, style = Config.italic_functions },
	...
	Keyword = { fg = C.purple, bg = C.none, style = Config.italic_keywords },
