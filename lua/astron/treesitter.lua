local treesitter = {
	...
	TSLabel = { fg = C.blue },
	TSKeyword = { fg = C.purple, style = Config.italic_keywords },
	TSKeywordFunction = { fg = C.purple, style = Config.italic_keywords },
	TSKeywordOperator = { fg = C.purple, style = Config.italic_keywords },
	...
	TSVariable = { fg = C.red, style = Config.italic_variables },
	TSVariableBuiltin = { fg = C.yellow, style = Config.italic_variables },
	TSText = { fg = C.fg },
	TSStrong = { fg = C.fg },
	TSEmphasis = { fg = C.fg },
	TSUnderline = { fg = C.fg },
